		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" acceptCharset="UTF-8" action="update" method="PUT" modelAttribute="model" enctype="multipart/form-data">
						    <input type="hidden" name="_method" value="PUT"/> <!-- Thêm trường ẩn -->
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Current Image</label>
						    <div class="col-sm-9">
						        <img src="${pageContext.request.contextPath}/image/${model.thumbnail }"alt="Current Image" width="100" height="100"/>
						    </div>
						</div> 
						...
						<form:hidden path="id" id="productID" name="productID"/>
